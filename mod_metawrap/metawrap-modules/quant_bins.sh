...
##### MANUAL UPD DEC 2023: SKIP THIS PART AS WE ONLY HAVE SINGLE-END READS ############
###### IRINA
...
######
### COMMENTED AS OF DEC 2023 TO SKIP INDEXING 
######
...
##### MANUAL UPD DEC 2023 by IRINA: REMOVE reads_2 as we only have single-end reads

mkdir ${out}/alignment_files
# If there are several pairs of reads passed, they are processed sepperately
for arg in "$@"; do
#	if [[ $arg == *"SRR22360819_1.fastq"* || $arg == *"SRR22360818_1.fastq"* || $arg == *"SRR22360817_1.fastq"* || $arg == *"SRR22360816_1.fastq"* || $arg == *"SRR22360815_1.fastq"* || $arg == *"SRR22360814_1.fastq"* ]]; then continue; fi
#	comm "processing sample $arg... checking if this was already processed"
...
#		if [[ $arg == "SRR22360819_1.fastq" || $arg == "SRR22360818_1.fastq" || $arg == "SRR22360817_1.fastq" || $arg == "SRR22360816_1.fastq" || $arg == "SRR22360815_1.fastq" || $arg == "SRR22360814_1.fastq" ]]; then continue; fi
		...
		comm "processing sample $sample with reads $reads_1 ..."
		salmon quant -i ${out}/assembly_index --libType IU -r $reads_1  -o ${out}/alignment_files/${sample}.quant --meta -p $threads
